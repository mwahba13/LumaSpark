...
export declare class LumaSplatsWebGL {
    ...
    skyboxTextureUpdatePayload: Array<UpdateTexturePayload<Uint8Array>>;
    ...
    compiledShaders: Map<number, Shader>;
    private lastEye;
    private lastDir;
...
export declare function getLumaShaderCode(shaderHooks?: LumaShaderHooks | null): {
    vertexShader: string;
